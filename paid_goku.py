...
# ============ CONFIGURATION ============
BOT_TOKEN = "8627427632:AAFWKf6iS-FqEtxeUjlIG8xpELpIZdRqpmE"
# ============ ADMIN & OWNER CONFIGURATION ============

BOT_OWNER = 6739493365  # Owner ID (Sirf isko cooldown nahi lagega)
...
API_LIST = [
    {
        "name": "Goku",
        "url": "http://165.245.178.39:5000/proxy",
        "key": "DX-GOKU01",
        "concurrent": 1,
        "max_time": 300,           # 🔥 Maxx max 240 seconds
        "enabled": False,
        "timeout": 30
    },
    {
...
def my_key_command(message):
    ...
    if not has_valid_key(user_id):
        safe_send_message(message.chat.id, "❌ You don't have a valid key! Contact Owner - @OWNER00001G", reply_to=message)
        return
...
def welcome_start(message):
    ...
    if is_owner(user_id):
        response = f'''👑 Welcome goku Owner, {user_name}!
...
if __name__ == "__main__":
    ...
    print("🚀 GOKU Paid Bot is running...")
    try:
