...
# CONFIGURATION
TOKEN = "8533356986:AAHjLOJM1p4ydTNemCjB372ObanmCFuQxyM"
OWNER_ID = 6739493365
VENV_PATH = "/home/goku/myenv/bin/activate"
BOT_DIR = "/home/goku"
...
<b>🚀 STARTING</b>
• /start_bot <code>&lt;session&gt;</code> <code>&lt;script&gt;</code>
<b>🛑 STOPPING</b>
• /stop_bot <code>&lt;session_OR_pid&gt;</code>
• /stop_all
<b>🔍 MONITORING</b>
• /list, /status
<b>📂 FILE MGMT</b>
• /read <code>&lt;path&gt;</code>
• Reply to file with /upload <code>&lt;path&gt;</code>
<b>💻 TERMINAL</b>
...
def terminal_gateway(message):
    ...
    bot.reply_to(message, f"🖥️ <b>Cmd:</b> <code>{command}</code>\n<pre>{html.escape(output[:4000])}</pre>", parse_mode="HTML")
...
def handle_upload(message):
    ...
    args = message.text.split()
    if len(args) != 2: return
    dest_path = args[1].replace("$HOME", "/home/goku")
    try:
        ...
        bot.reply_to(message, f"✅ Uploaded to: <code>{dest_path}</code>", parse_mode="HTML")
    except Exception as e:
